            ...
            <div className="main-container relative inline-flex flex-col items-start mx-auto my-0">
                ...
                <div className="profile-container padding">
                    ...
                    <div className="profile-introduce">
                        ...
                        <div className="profile-text" >연구실(AI Digital Twin Lab) 재직 중 진행한 국가 연구 프로젝트에서<br/>개발 외의 프로비저닝 시간을 줄이기 위해 Docker를 배우게 된 걸 계기로 DevOps의 세계에 발을 들였습니다.<br/>빌드 및 배포 자동화, 테스트 자동화를 국가 연구 프로젝트에 적용하여 개발 시간을 크게 단축했습니다. </div>
