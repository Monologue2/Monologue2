            ...
            <div className="main-container relative inline-flex flex-col items-start mx-auto my-0">
                ...
                <div className="profile-container padding">
                    ...
                    <div className="profile-introduce">
                        <div className="profile-text text-head3">Junior DevOps 엔지니어 유승언입니다.</div>
                        ...
                        <div className="profile-text" >저는 시간의 가치를 알며 Docker, Kubernetes와 CI/CD, 모니터링 툴을 사용하여 프로비저닝 시간을 단축하는 엔지니어입니다.<br/>현재까지도 개인 역량을 성장시키기 위해 공부를 멈추지 않고 있습니다. 감사합니다. </div>
                    </div>
                </div>
